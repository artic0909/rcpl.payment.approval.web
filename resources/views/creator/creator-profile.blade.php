                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card mb-4">
                                    ...
                                    <hr class="my-0" />
                                    <div class="card-body">
                                        <form action="{{ route('creator.profile.update') }}" method="POST" id="formAccountSettings">
                                            @csrf
                                            <div class="row">
                                                <div class="mb-3 col-md-6">
                                                    <label for="firstName" class="form-label">Creator's Name</label>
                                                    <input
                                                        class="form-control"
                                                        type="text"
                                                        name="name"
                                                        value="{{ Auth::guard('creator')->user()->name }}" />
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input
                                                        ...
                                                        name="email"
                                                        readonly
                                                        value="{{ Auth::guard('creator')->user()->email }}" />
                                                </div>
                                                <div class="mb-3 col-md-6">
