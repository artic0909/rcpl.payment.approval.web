            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="" class="app-brand-link gap-2">
                                ...
                                <span
                                    ...
                                    style="text-transform: capitalize">CREATOR | RCPL</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        ...
                        <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('creator.register.store') }}" enctype="multipart/form-data">
                            @csrf
