            ...
            <div class="payment-body">
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <form action="{{ route('stuff.login') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                      <label for="stuff_code" class="form-label"
                        >Staff Code</label
                      >
                    ...
                    <div class="mb-3 form-check">
                      ...
                      >
                      <a href="/stuff-forget-password" class="float-end">Forgot Password?</a>
                    </div>
