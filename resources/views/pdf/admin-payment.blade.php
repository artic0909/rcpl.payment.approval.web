...
<body>
    <div class="container">
        ...
        <table class="content-table">
            <tr>
                <td style="width: 60px;">
                    <img src="{{asset('./img/RCPL.png')}}" class="logo" alt="Logo">
                </td>
                <td class="header">
            ...
            <tr>
                <td style="width: 50%;">
                    <div class="checkbox-item">
                        <input type="checkbox" {{ in_array('Material Purchase', $selectedOptions) ? 'checked' : '' }} style="pointer-events: none;">
                        <span>Material Purchase</span>
                    </div>
                    <div class="checkbox-item">
                        <input type="checkbox" {{ in_array('Material Due Payment', $selectedOptions) ? 'checked' : '' }} style="pointer-events: none;">
                        <span>Material Due Payment</span>
                    </div>
                    <div class="checkbox-item">
                        <input type="checkbox" {{ in_array('Advance for Materials', $selectedOptions) ? 'checked' : '' }} style="pointer-events: none;">
                        <span>Advance for Materials</span>
                    </div>
                    <div class="checkbox-item">
                        <input type="checkbox" {{ in_array('Tools & Machinery Purchase', $selectedOptions) ? 'checked' : '' }} style="pointer-events: none;">
                        <span>Tools & Machinery Purchase</span>
                    </div>
                    <div class="checkbox-item">
                        <input type="checkbox" {{ in_array('Plant Machinery Rent', $selectedOptions) ? 'checked' : '' }} style="pointer-events: none;">
                        <span>Plant Machinery Rent</span>
                    </div>
                </td>
                <td style="width: 50%;">
                    <div class="checkbox-item">
                        <input type="checkbox" {{ in_array('Labour Cont. Payment', $selectedOptions) ? 'checked' : '' }} style="pointer-events: none;">
                        <span>Labour Cont. Payment</span>
                    </div>
                    <div class="checkbox-item">
                        <input type="checkbox" {{ in_array('Labour Cont. Due Payment', $selectedOptions) ? 'checked' : '' }} style="pointer-events: none;">
                        <span>Labour Cont. Due Payment</span>
                    </div>
                    <div class="checkbox-item">
                        <input type="checkbox" {{ in_array('Advance for Tools', $selectedOptions) ? 'checked' : '' }} style="pointer-events: none;">
