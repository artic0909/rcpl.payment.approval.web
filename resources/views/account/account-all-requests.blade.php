...
<head>
    ...
    <title>All Payments Requests | RCPL</title>
                ...
                <nav
                    ...
                    <div
                        ...
                        <div class="navbar-nav align-items-center">
                            <form action="{{ route('account.all-requests') }}" method="GET" class="d-flex align-items-center">
                                ...
                                <a href="{{ route('account.all-requests') }}" class="btn btn-secondary">Reset</a>
                            </form>
                        </div>
                        <!-- /Search -->
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr style="text-align: left;">
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="{{ route('account.payment.pdf.view', $request->id) }}" class="btn btn-primary mb-2"><i class='bx bx-file'></i></a>
                                                                ...
                                                                <a href="{{ route('account.payment.pdf.view', $request->id) }}" class="btn btn-warning mb-2"><i class='bx bx-file'></i></a>
