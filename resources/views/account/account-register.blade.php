            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-2">Register Now 🚀</h4>
                        <p class="mb-4">Register your account</p>

                        <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('account.register.store') }}" enctype="multipart/form-data">
                            @csrf

                            {{-- Name --}}
                            <div class="mb-3">
                                <label for="name" class="form-label">Account's Username</label>
                                <input
                                    type="text"
                            ...
                            {{-- Email --}}
                            <div class="mb-3">
                                <label for="email" class="form-label">Account's Email</label>
                                <input
                                    type="text"
                            ...
                            <div class="mb-3 form-password-toggle">
                                <label class="form-label" for="password">Account's Password</label>
