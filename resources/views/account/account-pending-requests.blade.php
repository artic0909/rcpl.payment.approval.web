                ...
                <nav
                    ...
                    <div
                        ...
                        <div class="navbar-nav align-items-center">
                            <form action="{{ route('account.pending-requests') }}" method="GET" class="d-flex align-items-center">
                                ...
                                <a href="{{ route('account.pending-requests') }}" class="btn btn-secondary">Reset</a>
                            </form>
                        </div>
                        <!-- /Search -->
                ...
                <div class="content-wrapper">
                    ...
                    <div class="modal fade" id="done{{ $request->id }}" data-bs-backdrop="static" tabindex="-1" aria-labelledby="done" aria-hidden="true">
                        <div class="modal-dialog">
                            <form class="modal-content" action="{{ route('account.payment.status', $request->id) }}" method="POST">
                                @csrf
