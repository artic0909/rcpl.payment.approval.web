                ...
                <nav
                    ...
                    <div
                        ...
                        <div class="navbar-nav align-items-center">
                            <form action="{{ route('account.approved-requests') }}" method="GET" class="d-flex align-items-center">
                                ...
                                <a href="{{ route('account.approved-requests') }}" class="btn btn-secondary">Reset</a>
                            </form>
                        </div>
                        <!-- /Search -->
                                    ...
                                    <div class="d-flex align-items-end row">
                                        <div class="col-sm-7">
                                            <div class="card-body">
                                                ...
                                                <p class="m-0">All payments are done</p>
                                            </div>
                                        </div>
                                        <div class="col-sm-5 text-center text-sm-left">
                                            <div class="card-body pb-0 px-0 px-md-4">
                                                <img
                                                    src="{{ asset('./img/transaction-approved.png') }}"
                                                    height="80"
                                                ...
                                                <table class="table responsive table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr style="text-align: left;">
                                                            ...
                                                            <td><span class="badge rounded bg-label-success fw-bold">{{ $request->payment_status }}</span></td>
                                                            ...
                                                            <td>
                                                                <a href="{{ route('account.payment.pdf.view', $request->id) }}" class="btn btn-success mb-2"><i class='bx bx-file'></i></a>
                                                            </td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
