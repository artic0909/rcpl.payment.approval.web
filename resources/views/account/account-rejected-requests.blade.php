                ...
                <nav
                    ...
                    <div
                        ...
                        <div class="navbar-nav align-items-center">
                            <form action="{{ route('account.rejected-requests') }}" method="GET" class="d-flex align-items-center">
                                ...
                                <a href="{{ route('account.rejected-requests') }}" class="btn btn-secondary">Reset</a>
                            </form>
                        </div>
                        <!-- /Search -->
