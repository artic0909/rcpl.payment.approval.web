...
<head>
    ...
    <title>All Approved Requests | RCPL</title>
                ...
                <nav
                    ...
                    <div
                        ...
                        <div class="navbar-nav align-items-center">
                            <form action="{{ route('admin.approved-requests') }}" method="GET" class="d-flex align-items-center">
                                ...
                                <a href="{{ route('admin.approved-requests') }}" class="btn btn-secondary">Reset</a>
                            </form>
                        </div>
                        <!-- /Search -->
                                        ...
                                        <div class="col-sm-7">
                                            <div class="card-body">
                                                <h5 class="card-title text-primary">
                                                    All Approved Payment Requests
                                                </h5>
                                            </div>
                                        </div>
                                        <div class="col-sm-5 text-center text-sm-right">
                                            <div class="card-body pb-0 px-0 px-md-4">
                                                <form method="GET" action="{{ route('admin.approved-requests') }}" class="form-inline justify-content-end" style="display: flex; align-items: end;" id="filterForm">
                                                    ...
                                                    <a href="{{ route('admin.approved-requests') }}" class="btn btn-secondary btn-sm mx-2">
                                        ...
                                        <div class="col-12">
                                            <script>
                                                function exportData() {
                                                    ...
                                                    let exportUrl = '{{ route("admin.approved.requests.export") }}?';
                                                    const params = [];
                                                ...
                                                <table class="table responsive table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr style="text-align: left;">
                                                            ...
                                                            <td><span class="badge rounded bg-label-success fw-bold">{{ $request->status }}</span></td>
